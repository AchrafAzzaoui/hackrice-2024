    ...
    for question_num in range(1, 3):
        ...
        if 'Incorrect' in evaluation or 'Partially Correct' in evaluation:
            ...
            if choice == '1':
                ...
                performance_entry['attempts'] = 2
                performance_entry['second_answer'] = user_answer_2
                performance_entry['second_evaluation'] = evaluation_2
                ...
                performance_entry['skipped'] = True
                difficulty = 'easier'
        else:
