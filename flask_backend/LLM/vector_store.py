...
load_dotenv("/Users/ekam/HackRice 2024/hackrice-2024/.env")
...
combined_text = "Python is a beautiful language. It's easy to learn and fun, and its syntax is simpleyet elegant."
ordered_topics, split_texts = knowledge_graph.getKnowledgeGraph("Arrays,Linked List", combined_text)
print('\n\n\n\n')

print("vector store", getVectorStore(ordered_topics, split_texts))
print('finished')
